...
//
//	See readme.md for usage, demo, and licensing info (MIT)
//

// Some modifications by Dogenes
// Not the best script, but it's small and it works.
...
if( isset($_GET['_CAPTCHA']) ) {
	...
	@session_name(isset($_GET["s"])?$_GET["s"]:'sphpc'); // Dogenes
	@session_start();
