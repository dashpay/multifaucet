...
if(PAYMENT_GW_RPC_HOST){
	//Use a Hot Wallet
	$PAYMENT_GATEWAY = new HotWallet(PAYMENT_GW_RPC_USER, PAYMENT_GW_RPC_PASS, PAYMENT_GW_RPC_HOST, PAYMENT_GW_RPC_PORT, PAYMENT_GW_RPC_ENCR, PAYMENT_GW_RPC_WALLET);
}
else{
